export const metadata = {
  ...
  summary: "株式会社衝動 announced a pre-seed round from the スパークル1号ファンド and unveiled Pixie Shield—a developer-first, one-command 10-minute security scanner built on Code Property Graphs and ML to keep false positives under 5%, priced at ¥1,000,000/year—advancing its rapid-resilience mission.",
}
